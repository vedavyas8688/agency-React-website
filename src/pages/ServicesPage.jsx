      ...
      <div className="grid lg:grid-cols-2 gap-16 items-center w-full">
        ...
        >
          ...
          <p className="mt-6 text-lg text-gray-600 dark:text-gray-300 max-w-xl">
            ...
            time closing deals with AI, Salesforce, and custom development built
            for their workflows.
          </p>
...
>
  <motion.div
    ...
    className="sm:col-span-2 text-center mb-3 mr-22"
  >
    <h1
      className="
  ...
  <motion.div variants={fieldVariants}>
    ...
    <input
      ...
      className="
        w-full p-3 text-sm bg-transparent outline-none
  ...
  <motion.div variants={fieldVariants} className="sm:col-span-2">
    ...
    <textarea
      ...
      className="
        w-full p-3 text-sm outline-none rounded-lg
